...
def compare_gt_vs_rec():
    ...
    plt.plot(areas, heights_gt, label="heights_gt Curve", linewidth=font_size * 0.2, linestyle='--')
    plt.plot(areas, heights_re, label="heights_re Curve", linewidth=font_size * 0.2, linestyle='--')

    plt.xlabel("dH (m)")
    plt.ylabel("Add Area (m2)")
