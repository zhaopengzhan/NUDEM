...
def main():
    init_path = r"/data/lyf/DeepZLab/projects/NUDEM/data1/小柴旦湖_utm_tmp.tif"
    contour_path = r'/data/lyf/DeepZLab/projects/NUDEM/data1/dem_intersection.tif'
    rel_contour_path = r'/data/lyf/DeepZLab/projects/NUDEM/data1/unknown/*.tif'

    vmin, vmax = 3119.0, 3124.0
    scale = vmax - vmin
